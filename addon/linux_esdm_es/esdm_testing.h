...
#define CONFIG_ESDM_RAW_HIRES_ENTROPY 1
#define CONFIG_ESDM_RAW_JIFFIES_ENTROPY 1
#define CONFIG_ESDM_RAW_IRQ_ENTROPY 1
#define CONFIG_ESDM_RAW_RETIP_ENTROPY 1
#define CONFIG_ESDM_RAW_REGS_ENTROPY 1
#define CONFIG_ESDM_RAW_ARRAY 1
#define CONFIG_ESDM_IRQ_PERF 1

#define CONFIG_ESDM_RAW_SCHED_HIRES_ENTROPY 1
#define CONFIG_ESDM_RAW_SCHED_PID_ENTROPY 1
#define CONFIG_ESDM_RAW_SCHED_START_TIME_ENTROPY 1
#define CONFIG_ESDM_RAW_SCHED_NVCSW_ENTROPY 1
#define CONFIG_ESDM_SCHED_PERF 1
